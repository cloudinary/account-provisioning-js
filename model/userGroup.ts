...
export class UserGroup {
    ...
    */
    'name'?: string;
    /**
    * A list of user group users. Only returned in extended_details. 
    */
    'users'?: Array<UserGroupUser>;
    /**
    * The date when the user group was created. Only returned in extended_details. 
    */
    'createdAt'?: Date;
    /**
    * The date when the user group was last updated. Only returned in extended_details. 
    */
    'updatedAt'?: Date;
