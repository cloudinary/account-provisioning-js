...
import { UserGroupUserResponse } from '../model/userGroupUserResponse';
...
export class UserGroupsApi {
     ...
     * @param userId 
     */
    public async addUserToUserGroup (groupId: string, userId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UserGroupUserResponse;  }> {
        ...
        return interceptorPromise.then(() => {
            ...
            return new Promise<{ response: http.IncomingMessage; body: UserGroupUserResponse;  }>((resolve, reject) => {
                localVarRequest(localVarRequestOptions, (error, response, body) => {
                    if (error) {
                        reject(error);
                    } else {
                        if (response.statusCode && response.statusCode >= 200 && response.statusCode <= 299) {
                            body = ObjectSerializer.deserialize(body, "UserGroupUserResponse");
     ...
     */
    public async createUserGroup (userGroupRequest?: UserGroupRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UserGroupResponse;  }> {
     ...
     * @param groupId 
     */
    public async deleteUserGroup (groupId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: MessageResponse;  }> {
     ...
     * @param groupId 
     */
    public async getUserGroup (groupId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UserGroupResponse;  }> {
        const localVarPath = this.basePath + '/user_groups/{group_id}'
            .replace('{' + 'group_id' + '}', encodeURIComponent(String(groupId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
     ...
     * @param userId 
     */
    public async removeUserFromUserGroup (groupId: string, userId: string, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UserGroupUserResponse;  }> {
        const localVarPath = this.basePath + '/user_groups/{group_id}/users/{user_id}'
            .replace('{' + 'group_id' + '}', encodeURIComponent(String(groupId)))
            .replace('{' + 'user_id' + '}', encodeURIComponent(String(userId)));
        let localVarQueryParameters: any = {};
     ...
     */
    public async updateUserGroup (groupId: string, userGroupRequest?: UserGroupRequest, options: {headers: {[name: string]: string}} = {headers: {}}) : Promise<{ response: http.IncomingMessage; body: UserGroupResponse;  }> {
        const localVarPath = this.basePath + '/user_groups/{group_id}'
            .replace('{' + 'group_id' + '}', encodeURIComponent(String(groupId)));
        let localVarQueryParameters: any = {};
        let localVarHeaderParams: any = (<any>Object).assign({}, this._defaultHeaders);
