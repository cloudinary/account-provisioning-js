 ...
 */
export function userGroupsAddUser(
...
> {
  const input: models.AddUserToUserGroupRequest = {
    groupId: groupId,
    userId: userId,
  };
  ...
  const parsed = safeParse(
    input,
    (value) => z.parse(models.AddUserToUserGroupRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UserGroupUser$inboundSchema),
    M.jsonErr(
