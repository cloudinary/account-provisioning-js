 ...
 */
export function userGroupsListUsers(
...
> {
  const input: models.GetUsersInUserGroupRequest = {
    groupId: groupId,
  };

  const parsed = safeParse(
    input,
    (value) => z.parse(models.GetUsersInUserGroupRequest$outboundSchema, value),
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UserGroupUsersResponse$inboundSchema),
