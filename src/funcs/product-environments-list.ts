...
> {
  const parsed = safeParse(
    ...
    (value) =>
      z.parse(
        z.optional(models.GetProductEnvironmentsRequest$outboundSchema),
        value,
      ),
  ...
  const query = encodeFormQuery({
    "cloud_names": payload?.cloud_names,
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.ProductEnvironmentsResponse$inboundSchema),
    M.jsonErr(
