...
> {
  const parsed = safeParse(
    request,
    (value) => z.parse(models.UpdateCustomPolicyRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.UpdateCustomPolicy, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.CustomPolicyResponse$inboundSchema),
    M.jsonErr(
      [400, 401, 403, 404, 409],
