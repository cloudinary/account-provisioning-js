 ...
 */
export function userGroupsRemoveUser(
...
> {
  const input: models.RemoveUserFromUserGroupRequest = {
    groupId: groupId,
    userId: userId,
  };
  ...
  const parsed = safeParse(
    input,
    (value) =>
      z.parse(models.RemoveUserFromUserGroupRequest$outboundSchema, value),
