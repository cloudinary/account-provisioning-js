...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(models.UpdateRolePrincipalsRequest1$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.UpdateRolePrincipalsRequest, {
    explode: true,
  });
  ...
  const context = {
    ...
    operationID: "updateRolePrincipals",
    oAuth2Scopes: null,
