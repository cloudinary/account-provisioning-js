 ...
 */
export function accessKeysUpdate(
...
> {
  const input: models.UpdateAccessKeyRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) => z.parse(models.UpdateAccessKeyRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.AccessKeyUpdateRequest, {
    explode: true,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.AccessKey$inboundSchema),
    M.jsonErr(
