 ...
 */
export function productEnvironmentsUpdate(
...
> {
  const input: models.UpdateProductEnvironmentRequest = {
  ...
  const parsed = safeParse(
    input,
    (value) =>
      z.parse(models.UpdateProductEnvironmentRequest$outboundSchema, value),
  ...
  const body = encodeJSON("body", payload.ProductEnvironmentUpdateRequest, {
    explode: true,
  });
