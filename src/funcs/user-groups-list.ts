...
> {
  const parsed = safeParse(
    request,
    (value) =>
      z.parse(z.optional(models.GetUserGroupsRequest$outboundSchema), value),
  ...
  const query = encodeFormQuery({
    "extended_details": payload?.extended_details,
  });
  ...
  const [result] = await M.match<
    ...
    | SDKValidationError
  >(
    M.json(200, models.UserGroupsResponse$inboundSchema),
