...
async function run() {
  const result = await cldProvisioning.userGroups.list(true);
...
async function run() {
  const res = await userGroupsList(cldProvisioning, true);
  if (res.ok) {
...
async function run() {
  const result = await cldProvisioning.userGroups.get("7f08f1f1fc910bf1f25274aef11d27", true);
...
async function run() {
  const res = await userGroupsGet(cldProvisioning, "7f08f1f1fc910bf1f25274aef11d27", true);
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await cldProvisioning.userGroups.update("7f08f1f1fc910bf1f25274aef11d27", {
...
async function run() {
  const res = await userGroupsUpdate(cldProvisioning, "7f08f1f1fc910bf1f25274aef11d27", {
    name: "Designers and Creatives",
  });
  if (res.ok) {
    const { value: result } = res;
...
async function run() {
  const result = await cldProvisioning.userGroups.delete("7f08f1f1fc910bf1f25274aef11d27");
...
async function run() {
  const res = await userGroupsDelete(cldProvisioning, "7f08f1f1fc910bf1f25274aef11d27");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await cldProvisioning.userGroups.listUsers("7f08f1f1fc910bf1f25274aef11d27");
...
async function run() {
  const res = await userGroupsListUsers(cldProvisioning, "7f08f1f1fc910bf1f25274aef11d27");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await cldProvisioning.userGroups.addUser("7f08f1f1fc910bf1f25274aef11d27", "0abed8dfcc039ea05e2a1d494fd442");
...
async function run() {
  const res = await userGroupsAddUser(cldProvisioning, "7f08f1f1fc910bf1f25274aef11d27", "0abed8dfcc039ea05e2a1d494fd442");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
...
async function run() {
  const result = await cldProvisioning.userGroups.removeUser("7f08f1f1fc910bf1f25274aef11d27", "0abed8dfcc039ea05e2a1d494fd442");
...
async function run() {
  const res = await userGroupsRemoveUser(cldProvisioning, "7f08f1f1fc910bf1f25274aef11d27", "0abed8dfcc039ea05e2a1d494fd442");
  if (res.ok) {
    const { value: result } = res;
    console.log(result);
  } else {
