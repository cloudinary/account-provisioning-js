...
| `sortBy`                                                                                               | [models.SortBy](../models/sortby.md)                                                                   | :heavy_minus_sign:                                                                                     | Which response parameter to sort by. **Possible values**: `api_key`, `created_at`, `name`, `enabled`.<br/> | created_at                                                                                             |
| `sortOrder`                                                                                            | [models.SortOrder](../models/sortorder.md)                                                             | :heavy_minus_sign:                                                                                     | Control the order of returned keys. **Possible values**: `desc` (default), `asc`.<br/>                 | asc                                                                                                    |